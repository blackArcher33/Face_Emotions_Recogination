    ...
    def get_frame(self):
        ...
        try:
            ...
            for (x,y,w,h) in faces_detected:  
                ...
                predection = model.predict(img.reshape((1,48,48,1)))

                max_indext = np.argmax(predection, axis=1)
                max_index = max_indext[0]

                # print('predection', predection)
                # print('max_indext', max_indext)
                # print('max_index', max_index)
                #print('confidence:', predection[0][max_index]*100)
                ...
                # print('max_index', max_index)
                # print('res',res)
                # print('Result %',res[max_index][0]*100)
                confidance = round(predection[0][max_index]*100,2)

                predicted_emotion = emotions[max_index]  +" "+ str(confidance) + " %"
